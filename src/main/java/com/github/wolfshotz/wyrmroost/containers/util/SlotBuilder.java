...
{
    @Nullable public Vector2D iconUV;
    private int limit = super.getMaxStackSize();
    private BooleanSupplier isEnabled = () -> true;
    private Predicate<ItemStack> isItemValid = super::access$0;
    private Predicate<Player> canTakeStack = super::access$1;
    ...
    public SlotBuilder iconUV(Vector2D uv)
    {
        this.iconUV = uv;
        return this;
    }
