...
public class LesserDesertwyrmEntity extends Animal implements IAnimatable
{
    ...
    private static final Predicate<LivingEntity> AVOIDING = t -> EntitySelector.ATTACK_ALLOWED.test(t) && !(t instanceof LesserDesertwyrmEntity);
    ...
    @Nullable
    @Override
    public AgableMob getBreedOffspring(ServerLevel level, AgableMob p_241840_2_)
    {
        return null;
    }
