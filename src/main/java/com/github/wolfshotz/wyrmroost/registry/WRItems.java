...
public class WRItems
{
    ...
    public static final RegistryObject<Item> LEATHER_DRAGON_ARMOR = register("leather_dragon_armor", () -> new DragonArmorItem.Dyeable(2, ArmorMaterials.LEATHER.getEnchantmentValue()));
    public static final RegistryObject<Item> IRON_DRAGON_ARMOR = register("iron_dragon_armor", () -> new DragonArmorItem(4, ArmorMaterials.IRON.getEnchantmentValue()));
    ...
    public static final RegistryObject<Item> GOLD_DRAGON_ARMOR = register("gold_dragon_armor", () -> new DragonArmorItem(6, ArmorMaterials.GOLD.getEnchantmentValue()));
    public static final RegistryObject<Item> DIAMOND_DRAGON_ARMOR = register("diamond_dragon_armor", () -> new DragonArmorItem(8, ArmorMaterials.DIAMOND.getEnchantmentValue()));
    public static final RegistryObject<Item> NETHERITE_DRAGON_ARMOR = register("netherite_dragon_armor", () -> new DragonArmorItem(10, ArmorMaterials.DIAMOND.getEnchantmentValue()));
    ...
    {
        public static final Named<Item> GEMS_GEODE = forge("gems/geodes");
        public static final Named<Item> DRAGON_MEATS = tag("dragon_meats");
        public static final Named<Item> INGOTS_PLATINUM = forge("ingots/platinum");

        private static Named<Item> tag(String path)
        {
