...
{
    public static final ResourceKey<LevelStem> THE_WYRMROOST = ResourceKey.create(Registry.LEVEL_STEM_REGISTRY, Wyrmroost.id("the_wyrmroost"));

    public static final ResourceKey<Biome> TINCTURE_WEALD = biomeKey("tincture_weald");
    public static final ResourceKey<Biome> FROST_CREVASSE = biomeKey("frost_crevasse");
    ...
    public static class Features
    {
        ...
        public static final RegistryObject<Feature<NoneFeatureConfiguration>> MOSS_VINES = REGISTRY.register("moss_vines", MossVinesFeature::new);
