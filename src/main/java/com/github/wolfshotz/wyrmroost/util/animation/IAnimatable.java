...
public interface IAnimatable
{
    ...
    static void registerCapability()
    {
        CapabilityManager.INSTANCE.register(IAnimatable.class, new Capability.IStorage<IAnimatable>()
        {
            ...
            @Nullable
            @Override
            public Tag writeNBT(Capability<IAnimatable> capability, IAnimatable instance, Direction side)
            {
                return null;
            }

            @Override
            public void readNBT(Capability<IAnimatable> capability, IAnimatable instance, Direction side, Tag nbt)
            {
            }
        }, CapImpl::new);
    }
